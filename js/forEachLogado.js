...
export default function exibirProdutoEditavel(titulo, preco, imagem, categoria) {
 return `       <div class="categoria__produtos--item">
               ...
               <button class="categoria__icone icone__deletar"><img src="./img/lixeira.svg" alt=""></button>
               ...
               <p class="categoria__id">#111111</p>
           </div>
 `
}
...
async function listaProdutos() {
    try {
        const listaApi = await conectaApi.listaProdutos();
            ...
            categoriaProduto.innerHTML += exibirProdutoEditavel(prod.titulo,prod.preco,prod.imagem,prod.categoria);
      });
  } catch (e) {
      console.log(e);
